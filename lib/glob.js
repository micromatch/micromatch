...
var lazyBraces = lazy('braces');
var lazyBrackets = lazy('expand-brackets');
var lazyExtglob = lazy('extglob');
var lazyParse = lazy('parse-glob');
...
Glob.prototype.extglob = function() {
  if (this.options.noextglob !== true && isExtglob(this.pattern)) {
    var extglob = lazyExtglob();
