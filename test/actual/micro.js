...
actual.should.eql(/^(?:(?:(?!(?:\/|^)\.).)*?\/(a|b)\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?js|(?:(?!(?:\/|^)\.).)*?\/(a|b)\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?md)$/);

var actual = fn("**/[a-z]/*.{js,md}");
actual.should.eql(/^(?:(?:(?!(?:\/|^)\.).)*?\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[a-z]\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?js|(?:(?!(?:\/|^)\.).)*?\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[a-z]\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?md)$/);
...
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/c\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?js)$/);

var actual = fn("a/**/c/*.md");
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/c\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?md)$/);

var actual = fn("a/**/j/**/z/*.js");
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/j\/(?:(?!(?:\/|^)\.).)*?\/z\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?js)$/);

var actual = fn("a/**/j/**/z/*.md");
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/j\/(?:(?!(?:\/|^)\.).)*?\/z\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?md)$/);

var actual = fn("a/**/z/*.js");
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/z\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?js)$/);

var actual = fn("a/**/z/*.md");
actual.should.eql(/^(?:a\/(?:(?!(?:\/|^)\.).)*?\/z\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]*?md)$/);
...
actual.should.eql(/^(?:a\/(?=.)\.[^/]*?\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]\/(?:(?!(?:\/|^)\.).)*?\/e\.js)$/);

var actual = fn("a/*/?/**/e.md");
actual.should.eql(/^(?:a\/(?=.)\.[^/]*?\/(?!(?:^|\/)\.{1,2}(?:$|\/))(?=.)[^/]\/(?:(?!(?:\/|^)\.).)*?\/e\.md)$/);
