...
// var res = patterns.reduce(function (acc, pattern) {
//   if (typeof pattern === 'string') {
//     acc = acc.concat('\n// ' + pattern.replace(/[\r\n]+/g, '\n// '));
//   } else if (typeof pattern[0] !== 'undefined') {
//     acc = acc.concat(wrap(pattern[0], regexps[i++]));
//   }
//   return acc;
// }, []);
...
// function wrap(a, b) {
//   return "assert.deepEqual(mm.makeRe('" + s(a) + "'), '" + s(b) + "');";
// }
